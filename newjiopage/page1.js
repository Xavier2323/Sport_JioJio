...
const Card = (props) => {
    if (props.title==1) return (
        <View style={{justifyContent:'center',alignItems:'center'}}>
            <Image style={{height:80,width:80}} source={require("../assets/badminton.png")}></Image>
            <Text>羽球</Text>
        </View>
    );
    else if (props.title==2) return (
        <View style={{justifyContent:'center',alignItems:'center'}}>
            <Image style={{height:80,width:80}} source={require("../assets/basketball.png")}></Image>
            <Text>籃球</Text>
        </View>
    );
    else if (props.title==3) return (
        <View style={{justifyContent:'center',alignItems:'center'}}>
            <Image style={{height:80,width:80}} source={require("../assets/soccer.png")}></Image>
            <Text>足球</Text>
        </View>
    );
    else return (
        <View style={{justifyContent:'center',alignItems:'center'}}>
            <Image style={{height:80,width:80}} source={require("../assets/baseball.png")}></Image>
            <Text>棒球</Text>
        </View>
    );
};
